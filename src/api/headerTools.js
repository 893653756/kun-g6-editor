...
export function saveAddUpdateRelations(payload) {
  if (payload.id) {
    return request.post('/api-clues/yp/snapshot/updateById', payload);
  } else {
    return request.post('/api-clues/yp/snapshot/save', payload);
  }
};
...
export function getRelationsList() {
  // return request.get('/api-clues/yp/snapshot/list');
  return {
    data: {
      content: [
        {
...
export function getRelationDetailById(id) {
  // return request.get(`/api-clues/yp/snapshot/findById/${id}`);
  return {
    data: {
      content: {
        "entities": [
